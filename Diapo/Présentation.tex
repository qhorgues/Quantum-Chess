...
\end{frame}
	...
	\begin{frame}
		...
		$\bullet$ Jeu d'échecs classique : finale gagnante pour les blancs mais difficile à gagner \newline
		$\bullet$ Jeu d'échecs quantique : stratégie simple pour avoir une chance de gagner rapidement 
		\includegraphics[scale = 0.8, center]{./pos1_exp1.jpg}	

	\end{frame}
	
	\begin{frame}
		\frametitle{Implémentation}
		$\bullet$ Représentations des différentes structures (plateau, pièces, matrice, qubit, ...) à l'aide du papier du chercheur Christopher Cantwell\newline
	...
	\begin{frame}
		...
		$\bullet$ Fonction d'évaluation des feuilles de l'arbre : \newline
		\begin{equation}
			\notag
			eval(\mathcal{B}) =
			\begin{cases}
	...
	\begin{frame}
		...
		$\bullet$ Profondeur = 4
		\includegraphics[scale = 0.9, center]{./pos2_exp1.jpg}	
	\end{frame}
	
	\begin{frame}
		\frametitle{Résolution sur un exemple}
	%	$\bullet$ Profondeur = 4
		\includegraphics[scale = 2.5, center]{./pos3_exp1.png}	
...
\end{frame}
	...
	\begin{frame}
		\frametitle{Résolution sur un exemple}
	%	$\bullet$ Profondeur = 4
		\includegraphics[scale = 2.5, center]{./pos4_exp1.png}	
	\end{frame}
		...
		\begin{equation}
			...
			\begin{cases}
				...
				-P & \text{ si la dame blanche est capturée et que le joueur noir a} \\ 
					& \text{ encore son cavalier et son fou} \\
				0 & \text{ sinon}
			\end{cases}       
		\end{equation}
...
\begin{frame}
	...
	\begin{center}
		...
		\begin{tabular}{ | l | c | }
			...
			Moyenne & 0.08 \\ \hline
			$-1 \leq val < -0.75$ & 5  \\ \hline
			$-0.75 \leq val < -0.5$ & 0  \\ \hline
			$-0.5 \leq val < -0.25$ & 2  \\ \hline
			$-0.25 \leq val < 0$ & 0 \\ \hline
			$val = 0 $   & 239  \\ \hline
			$0 < val < 0.25$ & 1  \\ \hline
			$0.25 \leq val < 0.5$ & 4  \\ \hline
			$0.5 \leq val < 0.75$ & 0  \\ \hline
			$0.75 \leq val \leq 1$ & 27  \\
			\hline
		\end{tabular}
	\end{center}	
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		...
		\begin{tabular}{ | l | c | }
			...
			Moyenne & 0.01 \\ \hline
			$-1 \leq val < -0.75$ & 1  \\ \hline
			$-0.75 \leq val < -0.5$ & 0  \\ \hline
			$-0.5 \leq val < -0.25$ & 1  \\ \hline
			$-0.25 \leq val < 0$ & 0 \\ \hline
			$val = 0 $   & 458  \\ \hline
			$0 < val < 0.25$ & 4  \\ \hline
			$0.25 \leq val < 0.5$ & 9  \\ \hline
			$0.5 \leq val < 0.75$ & 0  \\ \hline
			$0.75 \leq val \leq 1$ & 3  \\
			\hline
			\hline
		\end{tabular}
	\end{center}	
...
\begin{frame}
	...
	\begin{center}
		\begin{tabular}{ | l | c | }
			...
			Moyenne & 0.00 \\ \hline
			$-1 \leq val < -0.75$ & 0  \\ \hline
			$-0.75 \leq val < -0.5$ & 0  \\ \hline
			$-0.5 \leq val < -0.25$ & 0  \\ \hline
			$-0.25 \leq val < 0$ & 0 \\ \hline
			$val = 0 $   & 256  \\ \hline
			$0 < val < 0.25$ & 0  \\ \hline
			$0.25 \leq val < 0.5$ & 0  \\ \hline
			$0.5 \leq val < 0.75$ & 0  \\ \hline
			$0.75 \leq val \leq 1$ & 1  \\
			\hline
		\end{tabular}
	\end{center}
\end{frame}
	...
	$\bullet$ Les mouvements quantiques favorisent l'attaque \newline
